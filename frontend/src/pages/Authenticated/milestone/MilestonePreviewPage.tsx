...
const MilestonePreviewPage = () => {
  ...
  const generateMockMilestones = () => {
    const milestones = [];
    const types = ['initiation', 'influence'];
    const titles = [
  ...
  return (
    <div className="milestone-page-container">
      <div className="milestone-page-header">
        ...
        <p>Previewing all milestone images - 16 initiation, 22 influence</p>
        ...
        <div className="view-controls">
          ...
          {viewMode === 'gallery' && (
            <div className="type-filter">
              ...
              >
                <option value="all">All Types (38)</option>
      ...
      <div className="preview-summary">
        ...
        <p>Total Initiation: 16 | Total Influence: 22</p>
      </div>
    </div>
  );
};
