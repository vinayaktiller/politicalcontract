  ...
  import heartbeatNetworkSlice from './pages/Authenticated/heartbeat/heartbeatNetwork/heartbeatNetworkSlice';
  ...
  const rootReducer = combineReducers({
    ...
    heartbeatNetwork: heartbeatNetworkSlice,
  ...
  const persistConfig: PersistConfig<RootState> = {
    ...
    whitelist: [
      ...
      'questions', // Added questions to whitelist
      'blog',
