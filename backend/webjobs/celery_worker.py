#!/usr/bin/env python
"""
Celery Worker WebJob for Azure
...
print("🚀 Starting Celery Worker WebJob")
...
try:
    ...
    # Configure worker for your tasks
    options = {
        'queues': ['default', 'reports', 'activity'],
        'hostname': 'azure-webjob-celery-worker',
        'loglevel': 'INFO',
        'concurrency': 2,
        'maxtasksperchild': 10,
    }
    
    print("🚀 Celery worker starting with options:", options)
    worker.run(**options)
